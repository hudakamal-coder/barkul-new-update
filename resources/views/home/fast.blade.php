 ...
 <div class="container confood">
  <div class="row">
     @foreach ($fast as $row)
      ...
      <h4>{{ $row['name'] }} ......................{{ $row['price'] }} 

      <a href="{{ route('addcartfood',$row->id) }}"><i class="fa-solid fa-plus"></i></a>
      </h4>
      <br>
     

       @if ($row->big)
       <p class="ss">{{ $row->big }} <a href="{{ route('addcartfood',$row->id) }}"><i class="fa-solid fa-circle-plus" style="color: orangered;">
       </i></a></p>

       @if($row->medium )
       <p class="ss"> : {{$row->medium }} <a href="{{ route('addcartfood',$row->id) }}"><i class="fa-solid fa-circle-plus" style="color: orangered;">
       </i></a></p>

        @if($row->small)
        <p class="ss"> : {{$row->small}} <a href="{{ route('addcartfood',$row->id) }}"><i class="fa-solid fa-circle-plus" style="color: orangered;">
        </i></a></p>
       ...
       <p class="nosize">no size available</p>
     ...
     @endforeach
         ...
         <br>
              ...
              <h5 class="h5seefast">SeeMore Food <i class="fa-solid fa-arrow-right"></i></h5>
              <br><br>
              <div class="paginatfast1">
                {{ $fast->links() }}
              </div>
              <br><br>
